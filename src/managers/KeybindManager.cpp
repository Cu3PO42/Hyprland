...
bool CKeybindManager::onKeyEvent(wlr_keyboard_key_event* e, SKeyboard* pKeyboard) {
    ...
    const xkb_keysym_t keysymByKeyboard = xkb_state_key_get_one_sym(wlr_keyboard_from_input_device(pKeyboard->keyboard)->xkb_state, KEYCODE);
    const xkb_keysym_t keysym           = pKeyboard->resolveBindsBySim ? keysymByKeyboard : xkb_state_key_get_one_sym(m_pXKBTranslationState, KEYCODE);

    if (handleInternalKeybinds(keysymByKeyboard))
        return true;
